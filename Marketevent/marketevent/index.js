...
exports.backupMarketEvent = functions.https.onCall((data) => {
  fetch("https://ariztar-sandbox.myshopify.com/admin/api/2022-10/marketing_events.json", {
    headers: {
    ...
    data.products.forEach((doc)=>{
      ...
      const docRef = db.collection("MarketEvent").doc(todayDate).collection("data").doc();
