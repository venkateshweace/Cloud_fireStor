...
exports.backupDiscountCode = functions.https.onCall((data) => {
  fetch("https://ariztar-sandbox.myshopify.com/admin/api/2022-10/price_rules.json", {
    headers: {
    ...
    data.forEach((doc)=>{
      ...
      const docRef = db.collection("Backup's").collection("discountcode").doc(todayDate).collection("data").doc();
