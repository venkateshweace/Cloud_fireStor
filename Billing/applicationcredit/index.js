...
exports.backupApplicationcredit = functions.https.onCall((data) => {
  fetch("https://ariztar-sandbox.myshopify.com/admin/api/2022-10/application_credits.json", {
    headers: {
    ...
    data.recurring_application_charges.forEach((doc)=>{
      ...
      const docRef = db.collection("ApplicationCredit").doc(todayDate).collection("data").doc();
